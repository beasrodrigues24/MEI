...
data ProgTerm = Asg Vars LTerm | Choice ProbRep ProgTerm ProgTerm | Seq ProgTerm ProgTerm 
...
teste1 = Choice 0.5 xMaisy yMaisUm -- D [(X=1;Y=1;Z=-100,0.5),(X=0;Y=2;Z=-100,0.5)]
